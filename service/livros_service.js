...
exports.inserir = async function (livro) {
    if (livro && livro.titulo && livro.autor && livro.isbn && livro.ano && livro.edicao && livro.editora && livro.usuario) {
  ...
  exports.atualizar = async function(id, atualizacao) {
    const livroEncontrado = await livrosRepository.buscarPorId(id)
    if (livroEncontrado) {
        if (atualizacao && atualizacao.titulo && atualizacao.autor && atualizacao.isbn && atualizacao.ano && atualizacao.edicao && atualizacao.editora && atualizacao.usuario) {
